...
PROJECT_ID = "genial-wonder-440610-d4"
SUBSCRIPTION_ID = "bike-sharing-trips-subs-1"

INPUT_SUBSCRIPTION= 'projects/{}/subscriptions/{}'. \
    format(PROJECT_ID,SUBSCRIPTION_ID)

OUTPUT_TABLE = 'genial-wonder-440610-d4:rw_bikesharing.bike_trips_streaming'
